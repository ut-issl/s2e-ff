...
TEST(QuasiNonsingularRelativeOrbitalElements, ConstructorWithPositionVelocity) {
  ...
  QuasiNonsingularRelativeOrbitalElements qn_oe(reference_semi_major_axis_m, position_rtn_m, velocity_rtn_m_s, mu_m3_s2);

  double u = 0;
  libra::Vector<3> calc_position_rtn_m = qn_oe.CalcRelativePositionCircularApprox_rtn_m(u);
  libra::Vector<3> calc_velocity_rtn_m_s = qn_oe.CalcRelativeVelocityCircularApprox_rtn_m_s(u, mu_m3_s2);
