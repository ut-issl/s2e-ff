...
plt.figure(4)
plt.plot(time[0], inter_sat_distance_01[0], markersize=5, linestyle='None', marker="x", c="red",   label="distance_m-d1")
plt.plot(time[0], inter_sat_distance_02[0], markersize=5, linestyle='None', marker="x", c="green",   label="distance_m-d2")
plt.plot(time[0], diff_inter_sat_distance[0], markersize=5, linestyle='None', marker="x", c="blue",   label="difference_of_distance")
